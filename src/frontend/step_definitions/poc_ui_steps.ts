 ...
 */
Given(
    /^the user navigates to the Selenium Playground website$/,
    async function ({ page }) {
 ...
 */
When(
    /^the user selects the "([^"]*)" option from the navigation list$/,
...
Then(
    /^the user should see the "([^"]*)" page heading$/,
 ...
 */
Then(
    /^the user sets the "([^"]*)" date to "([^"]*)"$/,
    async function ({}, labelText: string, date: string) {
 ...
 */
Then(
    /^the user fills the text area inside the iframe with "([^"]*)"$/,
 ...
 */
Then(
    /^the user validates that the entered text matches the expected value$/,
    async function ({}) {
 ...
 */
When(
    /^the user clicks the Playwright Automation button in the web automation section inside the iframe$/,
    async function ({}) {
 ...
 */
When(
    /^the user validates that they have successfully navigated to the Playwright Automation page$/,
    async function ({}) {
