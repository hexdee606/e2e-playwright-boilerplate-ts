...
When(/^the user selects country "([^"]*)"$/, async function ({}, country: string) {
...
Then(/^the mocked UI components should be handled correctly for country "([^"]*)"$/, async function ({page}, country: string) {
